...
?>
          <div class="blog-post">
            <h2 class="blog-post-title"> <?= htmlspecialchars($data['title']);
        ?>
        </h2>
            <p class="blog-post-meta"> le <?= $data['updateDate_fr']?></p>
            <p><?= htmlspecialchars($data['content']) ?></p>
            <p><button> Commenter </button>
...
?> <!--
        ...
        <aside class="col-md-4 blog-sidebar">
          <div class="p-3 mb-3 bg-light rounded">
            <h4 class="font-italic">"Billet simple pour l'Alaska"</h4>
            <p class="mb-0">Etiam porta <em>sem malesuada magna</em> mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
          </div>

          <div class="p-3">
            <h4 class="font-italic">Les episodes</h4>
    ...
    <footer class="blog-footer">
      <p> Template exemple Bootstrap de blog</p>
    ...
    <script>window.jQuery || document.write('<script src="Public/Bootstrap/js/vendor/jquery-slim.min.js"><\/script>')</script>
    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
